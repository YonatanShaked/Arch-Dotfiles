...
require('lazy').setup({
  ...
  -- Dashboard + explorer + notifications
  {
    'folke/snacks.nvim',
    priority = 1000,
    lazy     = false,
...
╚═╝  ╚═══╝╚══════╝ ╚═════╝   ╚═══╝  ╚═╝╚═╝     ╚═╝]],
          keys = {
            ...
            { icon = '󰋗 ', key = '?', desc = 'Cheatsheet',   action = ':lua _G.ShowCheatsheet()' },
...
vim.keymap.set('n', '<leader>?', _G.ShowCheatsheet, { desc = 'Cheatsheet' })
